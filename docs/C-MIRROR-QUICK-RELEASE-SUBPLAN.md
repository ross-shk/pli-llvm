...
| CM4 | QR2.9 | object-like replacement, activation needed for replacement, and conditional compilation; safe recursive `%INCLUDE` is implemented | object-like macros, `#if` | 2w |
