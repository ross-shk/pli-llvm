...
| Ch.4 Data Description (declarations, attributes, storage, DEFINED, INITIAL, LIKE, FILE, structures) | (9)-(43) | QR1.1/QR2.1/QR2.3/QR2.6 | partial: `init_*`, `struct_init.pli`, `like.pli`, `defined.pli`, `driver/file` |
...
| Ch.6 Dynamic Structure (activation, storage, tasks, interrupts, ON/REVERT, checkout) | (60)-(63),(77),(82),(83),(87)-(99) | QR1.3/QR1.4/QR2.3/QR2.4/QR2.8 | partial: `alloc.pli`, `on_error.pli`, `on_cond.pli`; prefixes unenforced |
| Ch.7 I/O (file opening, list/data/edit stream, record, files) | (39),(40),(44)-(55),(100)-(113) | QR1.5/QR2.5 | partial: `get.pli`, `string.pli`, `edit.pli`, `e_format.pli`, `display.pli`, `driver/file` |
...
| App.3 Conditions | (91)-(99) | QR1.4/QR2.4 | partial: ERROR + `CONDITION(name)` (`on_error.pli`, `on_cond.pli`) |
