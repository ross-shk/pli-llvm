...
| Ch.7 I/O (file opening, list/data/edit stream, record, files) | (39),(40),(44)-(55),(100)-(113) | QR1.5/QR2.5 | partial: `get.pli`, `string.pli`, `edit.pli`, `e_format.pli`, `display.pli`, `put_data.pli`, `get_data.pli`, `driver/file`, sequential record `driver/record` |
